...
export const GUIDES: Guide[] = [
  {
    ...
    title: "The Best NBA Records Ever — and Why Nobody's Gone 82-0",
    description:
    ...
    intro: [
      "An undefeated NBA season — 82 wins, zero losses — has never happened, and almost certainly never will. The schedule is long, the travel brutal, and the league too deep for any team to escape 82 games unscathed.",
      "But a handful of teams pushed the limit of what's possible. Here are the five best regular seasons in NBA history — the closest anyone has come to perfection.",
    ],
    records: [
      { team: "Golden State Warriors", season: "2015–16", record: "73–9", blurb: "The best regular-season record ever, led by a unanimous-MVP Stephen Curry — and they still didn't win the title." },
  ...
  },
  {
    ...
    published: "2026-06-09",
    intro: [
      "In over a century of pro football, exactly one team has finished a season without a loss. Perfection in the NFL is so rare it's become legend.",
    ...
    records: [
      ...
      { team: "New England Patriots", season: "2007", record: "16–0", blurb: "The only 16-0 regular season — then they lost Super Bowl XLII, one win short of immortality." },
      { team: "Chicago Bears", season: "1985", record: "15–1", blurb: "One of the most dominant teams ever; a lone loss the only blemish before a Super Bowl rout." },
  ...
  },
  {
    ...
    published: "2026-06-09",
    intro: [
      "A 162-game baseball season makes 162-0 a mathematical fantasy — even the best teams lose 40-plus games. The grind is the whole point.",
  ...
  },
  {
    ...
    sport: "nhl",
    metaTitle: "Best NHL Records Ever — Fewest Losses & Most Wins in a Season",
  ...
  },
  {
    ...
    records: [
      ...
      { team: "Nebraska", season: "1995", record: "12–0", blurb: "Possibly the most dominant team in CFB history, winning by an average of nearly 40 points." },
  ...
  },
  {
    ...
    sport: "epl",
    metaTitle: "The Invincibles & the Best Premier League Seasons Ever",
    ...
    published: "2026-06-09",
    intro: [
      "No Premier League team has ever gone 38-0. But one came as close as anyone ever has — an entire 38-game season without a single defeat.",
    ...
    records: [
      ...
      { team: "Chelsea", season: "2004–05", record: "95 pts", blurb: "Mourinho's first title and the meanest defense the league has ever seen — 15 goals conceded." },
      { team: "Liverpool", season: "2019–20", record: "99 pts", blurb: "Ended a 30-year wait with the second-highest points total ever." },
    ],
    cta: "Nobody's gone 38-0. Build an all-time XI and chase the perfect season.",
    sources: [
