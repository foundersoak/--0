...
const mlbConfig: SportConfig = {
  ...
  eras: [
    { id: "1910s", label: "1910s", startYear: 1910, endYear: 1919, required: true },
    { id: "1920s", label: "1920s", startYear: 1920, endYear: 1929, required: true },
    { id: "1930s", label: "1930s", startYear: 1930, endYear: 1939, required: true },
    { id: "1940s", label: "1940s", startYear: 1940, endYear: 1949, required: true },
    { id: "1950s", label: "1950s", startYear: 1950, endYear: 1959, required: true },
