...
const franchises: FranchiseDef[] = [
  ...
  { id: "kings", name: "Sacramento Kings", abbr: "SAC", colors: ["#5A2D81", "#63727A"], activeEras: ALL_ERAS, aliases: [{ era: "1960s", name: "Cincinnati Royals" }] },
  ...
  { id: "nets", name: "Brooklyn Nets", abbr: "BKN", colors: ["#000000", "#777777"], activeEras: ALL_ERAS, aliases: [{ era: "1970s", name: "New York Nets" }, { era: "2000s", name: "New Jersey Nets" }] },
  { id: "rockets", name: "Houston Rockets", abbr: "HOU", colors: ["#CE1141", "#000000"], activeEras: ALL_ERAS },
  ...
  { id: "thunder", name: "Oklahoma City Thunder", abbr: "OKC", colors: ["#007AC1", "#EF3B24"], activeEras: ALL_ERAS, aliases: [{ era: "1990s", name: "Seattle SuperSonics" }, { era: "2000s", name: "Seattle SuperSonics" }] },
